...
Maize_ML_data <- merge(inputDataTrial, soildata_iSDA, by="trial_id")
...
Maize_ML_data <- merge(Maize_ML_data, weatherdata, by= "trial_id")
...
Maize_ML_trial %>% dplyr::select(-c(TLID, source, year,treatment_id, ref_trt, grain_yield_kgpha))